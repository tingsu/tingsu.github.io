...
2018-June 2019, NGF-2017-030033, S\$ 240,250. \textbf{Co-PI} (with PI: Prof. Yang Liu from NTU, Singapore)}
\item \normalfont{NTU SCSE, Research Demo Fund, ``Distributed and Automated Mobile App Testing Platform'', Jan
	2018-June 2018, S\$ 50,000. \textbf{Co-PI} (with PI: Prof. Yang Liu, and Co-PI: Guozhu Meng from NTU, Singapore)}
\item \normalfont{Continental, Continental Innovation Project, ``Investigation of AI Techniques for Software Engineering'', Jan 2019-May 2019, S\$ 75,000. \textbf{Co-PI} (with PI: Prof. Shang-Wei Lin and Co-PI: Yang Liu from NTU, Singapore)}
\end{itemize}
...
\normalfont{\textbf{\underline{Highlight of Published Papers}}:} Total number of published papers (26), ICSE(8), FSE(3), ASE(2), CSUR(1), PLDI(1)
...
\begin{enumerate}[leftmargin=*]
    ...
    \item $[$\textbf{TOSEM-19}$]$ \textbf{Ting Su}, Chengyu Zhang, Yichen Yan, Lingling Fan, Geguang Pu, Yang Liu, Zhoulai Fu and Zhendong Su. Towards Efficient Data-flow Test Data Generation. ACM Transactions on Software Engineering and Methodology. TOSEM 2019. (IF: 2.516) \emph{\underline{Major Revision}}.
