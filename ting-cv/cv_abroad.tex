...
\begin{enumerate}[leftmargin=*]
    ...
    \item $[$\textbf{ICSE-19}$]$ Sen Chen, Lingling Fan, Guozhu Meng, \textbf{Ting Su}, Minhui Xue, Yinxing Xue, Yang Liu, and Lihua Xu. AUSERA: Large-Scale Automated Security Risk Assessment of Global Mobile Banking Apps. 42nd International Conference on Software Engineering (ICSE). (\textbf{CCF-A}).
    \item $[$\textbf{ICSE-19}$]$ Anders Fischer-Nielsen, Zhoulai Fu, \textbf{Ting Su} and Andrzej Wąsowski. The Forgotten Case of the Dependency Bugs: On the Example of the Robot Operating System. 42nd International Conference on Software Engineering (ICSE). SEIP. 2020. \textbf{CCF-A}.
